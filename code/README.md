...
graphs generted by the assembler <a
...
PlasBin-flow is currently only available through a github repo.  

PlasBin-flow is composed of two main scripts:
- [code/plasbin_flow.py](plasbin_flow.py) is the main script used to
  process an assembly graph.
- [code/plasbin_utils.py](plasbin_utils.py) is a script used to tune
...
- [code/plasbin_flow.py](plasbin_flow.py) requires
...
- [code/plasbin_utils.py](plasbin_utils.py) requires the python modules
  ...
  as well as <a href="https://blast.ncbi.nlm.nih.gov/doc/blast-help/downloadblastdata.html">BLAST+
