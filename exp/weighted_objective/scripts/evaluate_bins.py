...
def main():
	...
	#Open output file
	if len_th > 0:
		unwtd_eval = args.eval_dir + '/pbf_eval_st'+str(len_th)+'.csv'
		wtd_eval = args.eval_dir + '/pbf_wtd_eval_st'+str(len_th)+'.csv'
	else:
		unwtd_eval = args.eval_dir + '/pbf_eval.csv'
		wtd_eval = args.eval_dir + '/pbf_wtd_eval.csv'
