...
#### Seeds file and parameters

A seed contigs file can be provided or seeds can be determined by parameters.
Parameters are used only if a seed contigs file is not provided.
...
The format of a seed contigs file is a single contig ID per line.
